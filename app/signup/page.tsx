    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--bg)' }}>
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>Create your account</h1>
          <p className="text-sm mt-1" style={{ color: 'var(--muted)' }}>Aron's ESAT Thing</p>
        </div>
        ...
        <p className="mt-5 text-center text-sm" style={{ color: 'var(--muted)' }}>
          ...
          <Link href="/login" className="font-semibold" style={{ color: 'var(--purple)' }}>Sign in</Link>
        </p>
      </div>
    </div>
  )
